...
architecture direction, risk analysis, and next-step planning. It is written as
an internal handoff artifact for sales engineering, product, architecture, and
delivery teams.
...
- Identify missing discovery information before architecture or pricing work.
- Recommend a scoped pilot that balances value, feasibility, and risk.
- Communicate an enterprise architecture using systems already present in the
