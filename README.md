...
- [Portfolio banner - PNG](examples/northstar_retail_group/visuals/portfolio_banner.png)
...
![Discovery Copilot portfolio banner](examples/northstar_retail_group/visuals/portfolio_banner.png)
...
`scripts/generate_portfolio_images.py` and committed so GitHub visitors can see
the portfolio story without installing extra tooling.
